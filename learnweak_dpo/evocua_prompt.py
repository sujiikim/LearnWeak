...
def _build_s2_tools_def(description_prompt):
    return {
        "type": "function", 
        "function": {
...
# System Prompt 생성
# ──────────────────────────────────────────────
def gen_SYSTEM_PROMPT(use_relative_resolution=True):
    if use_relative_resolution:
    ...
    tools_def = _build_s2_tools_def(description_prompt)
